...
// Import Modules
import { carbon2185 } from "./module/config.js";
...
Hooks.once("init", function() {
  ...
  Actors.registerSheet("carbon2185", ActorSheet5eCharacter, { types: ["character"], makeDefault: true });
  Actors.registerSheet("carbon2185", ActorSheet5eNPC, { types: ["npc"], makeDefault: true });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("carbon2185", ItemSheet5e, {makeDefault: true});
...
Hooks.once("setup", function() {
  ...
  for ( let o of toLocalize ) {
    const localized = Object.entries(CONFIG.carbon2185[o]).map(e => {
      return [e[0], game.i18n.localize(e[1])];
    });
    if ( !noSort.includes(o) ) localized.sort((a, b) => a[1].localeCompare(b[1]));
    CONFIG.carbon2185[o] = localized.reduce((obj, e) => {
      obj[e[0]] = e[1];
      return obj;
    }, {});
  }
