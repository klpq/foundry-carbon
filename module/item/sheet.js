...
export default class ItemSheet5e extends ItemSheet {
  ...
  _getItemStatus(item) {
    if ( item.type === "spell" ) {
      return CONFIG.carbon2185.spellPreparationModes[item.data.preparation];
    }
  ...
  _getItemProperties(item) {
    ...
    if ( item.type === "weapon" ) {
      props.push(...Object.entries(item.data.properties)
        .filter(e => e[1] === true)
        .map(e => CONFIG.carbon2185.weaponProperties[e[0]]));
    }
      ...
      props.push(CONFIG.carbon2185.equipmentTypes[item.data.armor.type]);
    ...
    if ( item.data.actionType ) {
      props.push(CONFIG.carbon2185.itemActionTypes[item.data.actionType]);
    }
  ...
  _onConfigureClassSkills(event) {
    ...
    const choices = skills.choices && skills.choices.length ? skills.choices : Object.keys(CONFIG.carbon2185.skills);
    const a = event.currentTarget;
    ...
    new TraitSelector(this.item, {
      ...
      choices: Object.entries(CONFIG.carbon2185.skills).reduce((obj, e) => {
